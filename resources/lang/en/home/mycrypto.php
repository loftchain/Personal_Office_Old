...
return [
  ...
  'enter_invest_wallet1' => 'Please enter your  ',
  'enter_invest_wallet2' => ' wallet address you will be transferring from: ',
  'exch_not_allowed' => 'You can`t use wallets from exchanges',
  'enter_ethereum_get_tokens' => 'Kindly insert the Ethereum wallet you wish to receive your EXM ERC20 Standard tokens in:',
  'dont_know_message' => 'To participate as an investor in the '.env('APP_NAME').' Token Sale you must select the currency and specify your receiving address for ETH.',
  'cancel_btn' => 'Cancel',
  'save_btn' => 'Save',

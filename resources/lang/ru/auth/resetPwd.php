...
return [
  ...
  'letterSentError_js' => 'К сожалению, письмо отправить не удалось. Для выяснения причин свяжитесь с администрацией.',
  ...
  'pwdNotEqual_ResetPasswordsTrait' => 'Пароли должны быть одинаковыми',
	...
	'expiredToken_h2' => 'Жизненный цикл токена подошёл к концу, попробуйте восстановить пароль еще раз.',
	'goBack_button' => 'Назад'
];
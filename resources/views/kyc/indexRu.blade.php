...
<div class="a-body a2-body">
    ...
    <div class="a-container a2-container">
        ...
        <section class="a2-container__section doc-section">
            <form id="upload" method="post" action="{{ route('kyc.upload.img') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div id="drop">
        ...
        <section class="a2-container__section text-section">
            <form class="a2-form" method="POST" accept-charset="multipart/form-data" enctype="multipart/form-data" action="{{ route('kyc.store') }}">

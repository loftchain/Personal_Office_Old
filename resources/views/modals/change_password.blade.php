      ...
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel">{!! trans('modals/modals.changePassword_title') !!}</h4>
              </div>
              <form id="changePwdForm" class="x-form"  method="POST" action="{{ route('renew_password') }}">
                      {{ csrf_field() }}
                      <label for="email" class="x-label email-label">{!! trans('modals/modals.changePasswordCurrent_emailLabel') !!}</label>
                      <input type="email" name="email" class="x-input email-input">
                      <div class="error-message error-message0 email not_your_email"></div>

                      <label for="password1" class="x-label email-label">{!! trans('modals/modals.changePasswordNew_label') !!}</label>
                      ...
                      <label for="password2" class="x-label email-label">{!! trans('modals/modals.newPassword_label')!!}</label>
                  ...
                  <div class="modal-footer">
                      <button type="submit" class="modal-btn">
                        ...
                        {!! trans('modals/modals.change_btn') !!}
                      </button>
                  </div>
              </form>
          </div>

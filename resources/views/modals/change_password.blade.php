      ...
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <form id="changePwdForm" class="x-form"  method="POST" action="{{ route('renew_password') }}">
                      ...
                      <label for="password1" class="x-label email-label">@lang('home/change_password.cur_pwd')</label>
                      ...
                      <label for="password2" class="x-label email-label">@lang('home/change_password.new_pwd')</label>

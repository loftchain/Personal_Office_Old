      ...
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel">{!! trans('modals/modals.changeEmail_title') !!}</h4>
              </div>
              <form id="changeEmailForm" class="x-form"  method="POST" action="{{ route('reset_email') }}">
                  {{ csrf_field() }}
                  <label for="email1" class="x-label email-label">{!! trans('modals/modals.currentEmail_label') !!}</label>
                  ...
                  <label for="email2" class="x-label email-label">{!! trans('modals/modals.newEmail_label') !!}</label>
                  <input type="text" class="x-input" name="email2">
                  <div class="error-message error-message1 email2 not_equal is_taken"></div>

                  <label for="password" class="x-label email-label">{!! trans('modals/modals.уourPassword_label') !!}</label>

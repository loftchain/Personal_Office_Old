    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">{!! trans('modals/modals.signIn_title') !!}</h4>
            </div>
            <form id="loginForm" class="l-form" method="POST" action="{{ route('login') }}">
                    {{ csrf_field() }}
                    <label for="email" class="x-label l-label email-label">{!! trans('modals/modals.enterYourEmail_label') !!}</label>
                    ...
                    <label for="password" class="x-label l-label password-label ">{!! trans('modals/modals.уourPassword_label') !!}</label>
                ...
                <div class="modal-footer">
                    <button type="submit" class="modal-btn">
                      ...
                      {!! trans('modals/modals.signIn_btn') !!}
                    </button>
                </div>
            </form>

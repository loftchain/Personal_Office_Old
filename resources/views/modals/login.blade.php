    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">@lang('modals/modals.signIn_title')</h4>
            </div>
            <form id="loginForm" class="l-form" method="POST" action="{{ route('login') }}">
                    {{ csrf_field() }}
                    <label for="email" class="x-label l-label email-label">@lang('modals/modals.enterYourEmail_label')</label>

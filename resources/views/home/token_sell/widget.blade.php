  ...
  <article id="squareAndCurrencies">
    ...
    <section id="Currencies">
      <nav class="crypto">
        ...
        <div class="crypto__box crypto__LTC">
          <img  class="img_LTC crypto__img crypto__currency2_img"
                {{--src="{{ asset('img/ltc-icon.png') }}"--}}
                alt="">
          <div class="crypto__currency-container">
            <div class="crypto__currency_val crypto__currency2_val"></div>
            <div class="crypto__currency_name crypto__currency2_name"></div>
          </div>
        </div>
      </nav>
      ...
      <div class="value-box">
        <nav class="real-money">
          <span class="dollar">$</span><span class="first_sum"></span><span class="dollar"> of $</span><span class="second_sum"></span>
        </nav>
        <nav class="token-box">
          <span class="token-sold token_sold"></span> <span class="token-name"> {{ env('TOKEN_NAME') }}</span> of <span class="token-cap token_cap"></span><span class="token-name"> {{ env('TOKEN_NAME') }}</span>
        </nav>
      </div>
    </section>
  </article>
    ...
    <section id="rounds">
      <div class="rounds__second progress rounds__progress outer rounds__outer">
        ...
        <div class="rounds__range rounds__i-range">
          ...
          <div class="range__shaded i-range__shaded">
            ...
            <span class="range__shaded_name range__shaded_i">@lang('home/widget.round_1')</span>
          </div>
          <div class="range__interval i-range__interval"></div>
        </div>
      </div>

      {{--<span class="range__shaded_name range__shaded_pi">Round 1</span>--}}
    </section>
  </article>

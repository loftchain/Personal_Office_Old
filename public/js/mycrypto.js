...
// });
//
// var mycrypto_text1, mycrypto_text2_0, mycrypto_text2_1, mycrypto_text2_1;
//
...
//         m.pay_wallet_label.html(mycrypto_text2_0 + localStorage.getItem('current-currency') + mycrypto_text2_1 + " <br>" + mycrypto_text2_2);
//         $('.error-message2').css('text-align', 'left')
//     }
// }
...
trait RegisterMailTrait
{
  ...
  public function sendConfirmationEmail($data, $timeout, $subscription)
  {

    $api_key = "6jbnone8wamhti3m7duz5wjypxki8mhua9853mdo";
    $user_email = $data['email']; // юзер
    $user_lists = env('UNISENDER_ID'); // не менять
    ...
    if($subscription){
      $POST['fields[PWD]'] = 'Use this password to enter '.$data['password'];
    }
